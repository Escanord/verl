#!/usr/bin/env bash
# GRPO training on guru-RL-92k with Qwen2.5-3B-Instruct on 8x H200.
set -x
...
VERL_FILE_LOGGER_ROOT=/storage/workspace/server-1/duy/checkpoints/verl/grpo \
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2_5_3b_guru_rl' \
