#!/usr/bin/env bash
# PIVOT-v2 seeded from GRPO step-320 checkpoint.
#
...
#
# Starting from GRPO-320 (plateau at 61.5% MATH500 / 1.8% AIME) satisfies
...
MODEL="${MODEL:-/storage/workspace/server-1/duy/checkpoints/verl/grpo/qwen2_5_3b/global_step_320/actor/huggingface_merged}"
REWARD_FN="$(dirname "$0")/guru_rl_reward.py"

train_files="$DATA_DIR/train.parquet"
val_files="['$DATA_DIR/test_aime.parquet','$DATA_DIR/test_math500.parquet']"

CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v2-from-grpo320/qwen2_5_3b
...
VERL_FILE_LOGGER_ROOT=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v2-from-grpo320 \
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2_5_3b_pivot_v2_from_grpo320' \
