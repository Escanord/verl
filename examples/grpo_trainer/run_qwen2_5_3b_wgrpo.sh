#!/usr/bin/env bash
# W-GRPO: Walk-Weighted GRPO on guru-RL-92k with Qwen2.5-3B-Instruct on 8x H200.
# Extends GRPO with layer-averaged Sketch-Determined Walk advantage reweighting.
#
# Key additions vs run_qwen2_5_3b_guru_rl.sh:
#   algorithm.use_walk_weighted_advantage=True
#   algorithm.walk_alpha=1.0          # Â_t = Â * (1 + alpha * w̃_block(t))
...
VERL_FILE_LOGGER_ROOT=/storage/workspace/server-1/duy/checkpoints/verl/wgrpo \
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2_5_3b_wgrpo' \
