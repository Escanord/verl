#!/usr/bin/env bash
# WGRPO-v6-block64: v6 differential walk with block_size=64 (up from 32).
#
# Identical to v6 in all respects except block_size=64.
# Tests whether coarser block granularity (64 vs 32 tokens/block) helps or hurts.
# block_size=16 underperformed v6 despite earlier breakthrough — checking the
# other direction to characterize the block_size sensitivity curve.
#
...
export VERL_FILE_LOGGER_ROOT=/storage/workspace/server-1/duy/checkpoints/verl/wgrpo-v6-block64
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.walk_importance.block_size=64 \
    ...
    trainer.experiment_name='qwen2_5_3b_wgrpo_v6_block64' \
