#!/usr/bin/env bash
# High-Entropy GRPO (top-20% entropy tokens only) on Qwen3-1.7B-Base.
#
...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/high-ent-grpo/qwen3_1p7b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1p7b_base_grpo_high_ent' \
