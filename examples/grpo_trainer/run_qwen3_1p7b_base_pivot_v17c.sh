#!/usr/bin/env bash
# PIVOT-v17c on Qwen3-1.7B-Base.
#
# PIVOT-v17c Langevin settings:
#   - trigger-to-trigger G feedback (γ=0.7, α=0.6, no Adam-RMS)
#   - entropy_trigger_only, trig_percentile=65, min_trigger_position=200
#
# KL: 0.001 (Langevin perturbations can push the policy away from reference)
set -x
...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v17c/qwen3_1p7b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1p7b_base_pivot_v17c' \
