...
#    signal = H_current - H_first*alpha.  H_first is the entropy at the first
#    trigger this trajectory.  alpha=0.7 allows 30% entropy decay from
#    trajectory start before reversing.
...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v18/qwen3_1p7b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1p7b_base_pivot_v18' \
