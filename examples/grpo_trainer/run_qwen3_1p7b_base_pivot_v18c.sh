...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v18c/qwen3_1p7b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1p7b_base_pivot_v18c' \
