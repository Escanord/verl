#!/usr/bin/env bash
# PIVOT-v21 (DRIFT-v21) on Qwen3-1.7B-Base.
#
...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/pivot-v21/qwen3_1p7b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1p7b_base_pivot_v21' \
