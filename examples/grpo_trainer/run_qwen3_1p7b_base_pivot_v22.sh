#!/usr/bin/env bash
# PIVOT-v22 (DRIFT-v22) on Qwen3-1.7B-Base.
#
...
# per-token KL, get heavy penalty.  Sum-of-KL (verl default) would bias
# the wrong direction since long rollouts have more tokens.
#
...
# per-length-stratum reward distribution at every train step.
#
...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/pivot-v22/qwen3_1p7b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1p7b_base_pivot_v22' \
