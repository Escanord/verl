#!/usr/bin/env bash
# DRIFT-v22 neffmax on Qwen3-1.7B-Base — scaled-down replica of the 4B
# neffmax run. Matched 1:1 to the 1.7B GRPO baseline (run_qwen3_1p7b_base_
# grpo_matched.sh): identical data / reward (strict-box \boxed{}) / batch 1024
# / KL, symmetric clip 0.2/0.2, use_kl_in_reward=False, resp_len 16384.
...
#   - N_eff BAND trigger: fire iff 2 <= 1/Σp² <= 8 (replaces entropy+tmin).
...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/pivot-v22/qwen3_1p7b_base_neffmax
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_1p7b_base_pivot_v22_neffmax_${SLURM_JOB_ID:-manual}" \
