#!/usr/bin/env bash
# DRIFT-v22 neffnoise on Qwen3-1.7B-Base — scaled-down replica of the 4B
# neffnoise run. Matched 1:1 to the 1.7B GRPO baseline (run_qwen3_1p7b_base_
...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/pivot-v22/qwen3_1p7b_base_neffnoise
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_1p7b_base_pivot_v22_neffnoise_${SLURM_JOB_ID:-manual}" \
