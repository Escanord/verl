#!/usr/bin/env bash
# DAPO on Qwen3-4B-Base — paper-scale config matching Wang et al. 80/20 §5.2.
# Identical to run_qwen3_8b_base_dapo.sh (same algorithmic & batch knobs incl.
# ppo_micro_batch_size_per_gpu=1); only the model path differs.
#
...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/dapo/qwen3_4b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_4b_base_dapo' \
