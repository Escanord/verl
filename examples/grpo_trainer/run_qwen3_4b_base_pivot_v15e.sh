...
#   policy gradient flows only at the ~20% positions where Langevin fired,
#   perfectly aligning IS correction, Langevin perturbation, and pg_loss.
set -x
...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v15e/qwen3_4b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.pivot.langevin_min_trigger_position=40 \
    ...
    trainer.project_name='verl_pivot_v15e_qwen3_guru_rl' \
    trainer.experiment_name='qwen3_4b_base_pivot_v15e' \
