#!/usr/bin/env bash
# PIVOT-v15f on Qwen3-4B-Base.
#
# v15e + momentum Langevin (underdamped / kinetic Langevin).
#
# A velocity vector v ∈ R^|vocab| persists across trigger positions within
...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v15f/qwen3_4b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_pivot_v15f_qwen3_guru_rl' \
    trainer.experiment_name='qwen3_4b_base_pivot_v15f' \
