#!/usr/bin/env bash
# PIVOT-v15g on Qwen3-4B-Base.
#
# v15e + MALA correction on the Langevin step.
#
...
# larger step sizes (langevin_eta=0.3 vs 0.1) because bad steps are rejected
# rather than accumulated. Acceptance rate ~70-85% in the top-k=20 logit space.
set -x
...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v15g/qwen3_4b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.pivot.entropy_threshold=0.6 \
    ...
    trainer.project_name='verl_pivot_v15g_qwen3_guru_rl' \
    trainer.experiment_name='qwen3_4b_base_pivot_v15g' \
