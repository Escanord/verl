#!/usr/bin/env bash
# PIVOT-v17c-dapo: DAPO + PIVOT-v17c on Qwen3-4B-Base.
#
...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v17c-dapo/qwen3_4b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_4b_base_pivot_v17c_dapo' \
