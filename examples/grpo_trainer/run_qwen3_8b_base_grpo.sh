#!/usr/bin/env bash
# Vanilla GRPO on Qwen3-8B-Base — baseline for PIVOT/DAPO comparison.
set -x
...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/grpo/qwen3_8b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_8b_base_grpo' \
