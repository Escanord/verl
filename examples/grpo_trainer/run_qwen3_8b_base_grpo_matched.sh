#!/usr/bin/env bash
# Vanilla GRPO on Qwen3-8B-Base — matched baseline for the DRIFT-v22
# neffnoise-cap2 8B run (run_qwen3_8b_base_pivot_v22_neffnoise_cap2.sh).
# Identical data / reward (strict-box \boxed{}) / batch 1024 / KL / clip
# 0.2-0.2 / use_kl_in_reward=False / resp_len 16384. Only difference vs
# neffnoise is DRIFT on/off. Scale-up of run_qwen3_4b_base_grpo_matched.sh.
...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/grpo/qwen3_8b_base_matched
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_grpo_qwen3_guru_rl' \
    trainer.experiment_name="qwen3_8b_base_grpo_matched_${SLURM_JOB_ID:-manual}" \
