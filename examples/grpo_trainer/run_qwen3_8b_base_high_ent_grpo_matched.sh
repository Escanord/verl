...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/high-ent-grpo/qwen3_8b_base_matched
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_8b_base_high_ent_grpo_matched_${SLURM_JOB_ID:-manual}" \
