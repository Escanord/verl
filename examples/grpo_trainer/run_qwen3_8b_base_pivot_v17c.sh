...
CKPT_DIR=/storage/workspace/server-1/duy/checkpoints/verl/pivot-v17c/qwen3_8b_base
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_8b_base_pivot_v17c' \
