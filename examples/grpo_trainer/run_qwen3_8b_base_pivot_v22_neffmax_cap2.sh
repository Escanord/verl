#!/usr/bin/env bash
# DRIFT-v22 neffmax on Qwen3-8B-Base with soft-IS ceiling raised to 2.
...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/pivot-v22/qwen3_8b_base_neffmax_cap2
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_8b_base_pivot_v22_neffmax_cap2_${SLURM_JOB_ID:-manual}" \
