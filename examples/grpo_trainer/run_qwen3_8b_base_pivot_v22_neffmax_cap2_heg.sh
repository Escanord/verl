...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/pivot-v22/qwen3_8b_base_neffmax_cap2_heg
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_8b_base_pivot_v22_neffmax_cap2_heg_${SLURM_JOB_ID:-manual}" \
