#!/usr/bin/env bash
# DRIFT-v22 neffnoise on Qwen3-8B-Base with default soft-IS clamp (cap=1, w=min(1, pi_old/pi_lan_old)).
...
#   - langevin_top_k=128, langevin_exploit_ratio=0.9 (noise ON).
...
CKPT_DIR=/home/escanord/duy/checkpoints/verl/pivot-v22/qwen3_8b_base_neffnoise
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_8b_base_pivot_v22_neffnoise_${SLURM_JOB_ID:-manual}" \
